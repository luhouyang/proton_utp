    ...
    return Scaffold(
        ...
        children: [
          ...
          FloatingActionButton.small(
            onPressed: () async {
              ...
              debugPrint('Animations : $availableAnimations -- Length : ${availableAnimations.length}');
          ...
          FloatingActionButton.small(
            onPressed: () async {
              ...
              debugPrint('Textures : $availableTextures -- Length : ${availableTextures.length}');
      ...
      body: Container(
        ...
        child: Flutter3DViewer(
          // "PROTON X50 ARLETALINK" (https://skfb.ly/oNSRN) by crack122001 is licensed under Creative Commons Attribution (http://creativecommons.org/licenses/by/4.0/).
          // progressBarColor: Colors.blue,
          // controller: controller,
          src: 'assets/PROTON_X50.glb', //3D model with different animations
